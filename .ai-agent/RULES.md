...
This file contains the rules that all AI agents must follow. Each rule is defined in a separate file
...
- [Max Lines per File](../.kilocode/rules/max-lines-per-file.md)
- [Max Lines per Method](../.kilocode/rules/max-lines-per-method.md)
- [No Commented Code](../.kilocode/rules/no-commented-code.md)
- [Self-Documenting Code](../.kilocode/rules/self-documenting-code.md)
- [Max Depth](../.kilocode/rules/max-depth.md)
