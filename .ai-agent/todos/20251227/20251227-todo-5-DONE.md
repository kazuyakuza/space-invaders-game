...
- [DONE] Create `src/ts/__tests__/Game.test.ts`.
- [DONE] Mock the `levels.json` import using `vi.mock`.
- [DONE] Initialize a `Game` instance and call the resolution logic.
- [DONE] Assert the final configuration objects.
